...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'post post-' . $blog_display ); ?>>
    ...
    <?php if ( $blog_display == 'row' ): ?>
        ...
        <div class="post-content zhelpwanted-content">
            <h2><a href="<?php echo esc_attr( get_the_permalink() ); ?>"><?php the_title(); ?></a></h2>
            <?php the_excerpt(); ?>
        </div><!-- /.post-content -->

        <div class="post-meta clearfix">
            <?php /* zig xout <div class="post-meta-author"><?php echo esc_attr__( 'By', 'superlist' ); ?> <?php the_author_posts_link(); ?></div><!-- /.post-meta-author -->
